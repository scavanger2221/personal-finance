                    ...
                    <div className="relative z-10 flex flex-col justify-between p-16">
                        ...
                        >
                            <blockquote className="text-2xl font-light text-text-primary leading-relaxed tracking-tight">
                                &quot;Mulai perjalanan finansial Anda dengan langkah pertama.&quot;
                            </blockquote>
                            <p className="mt-4 text-sm text-text-tertiary">
                                — Daftar sekarang dan kelola keuangan dengan bijak
                            </p>
                        </motion.div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-12 lg:px-20 xl:px-24">
                    ...
                    >
                        ...
                        <div className="mb-10">
                            ...
                            >
                                Mulai atur keuangan Anda dengan lebih baik hari ini.
                            </motion.p>
                        </div>
                        ...
                        >
                            <div>
                                <InputLabel htmlFor="name" value="Nama Lengkap" className="text-sm font-medium text-text-secondary mb-2" />
                                <TextInput
                                    id="name"
                                    name="name"
                                    value={data.name}
                            ...
                            <div>
                                <InputLabel htmlFor="password" value="Kata sandi" className="text-sm font-medium text-text-secondary mb-2" />
                                <TextInput
                                    id="password"
                                    type="password"
                                    name="password"
